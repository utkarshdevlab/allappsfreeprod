...
const VibeMaster = () => {
    ...
    return (
        <div className="space-y-8">
            ...
            {/* SEO Content */}
            <SEOContent title="Master Your Focus Environment">
                <p>
                ...
                <FeaturesSection
                    title="Key Benefits"
                    features={[
                        "Reduce cognitive load by masking distracting noises",
                        "Trigger \"Deep Work\" state using rhythmic lofi layers",
                        "Relieve anxiety with natural rain and cafe textures",
                        "Customizable intensity for perfect background balance"
                    ]}
                />

                <UseCasesSection
                    title="How to Craft Your Perfect Vibe"
                    cases={[
                        { title: "Choose Preset", description: "Select from Midnight, Solstice, or Neon to set the visual mood and base frequency." },
                        { title: "Layer Sounds", description: "Toggle the high-fidelity loops that match your current creative intention." },
                        { title: "Mix Intensity", description: "Fine-tune the volume sliders to achieve the perfect balance for your space." }
                    ]}
                />
            </SEOContent>
        </div>
